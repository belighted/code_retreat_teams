...
class ParticipationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create participation" do
    assert_difference("Participation.count") do
      post participations_url, params: { participation: { code_retreat_session_id: @participation.code_retreat_session_id, primary_technology_id: @participation.primary_technology_id, secondary_technology_id: @participation.secondary_technology_id, user_id: @participation.user_id } }
    end
  ...
  test "should update participation" do
    patch participation_url(@participation), params: { participation: { code_retreat_session_id: @participation.code_retreat_session_id, primary_technology_id: @participation.primary_technology_id, secondary_technology_id: @participation.secondary_technology_id, user_id: @participation.user_id } }
